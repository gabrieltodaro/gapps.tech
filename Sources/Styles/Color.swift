...
public struct Color: CustomStringConvertible, Sendable {
    ...
    /// The HTML color name "gappsIndigo" (#25245E)
    public static let gappsIndigo = Color(hex: "#25245E")
    
    /// The HTML color name "gappsLightGoldenrod" (#FEF9D6)
    public static let gappsLightGoldenrod = Color(hex: "#FEF9D6")
    
    /// The HTML color name "gappsWatermelon" (#F0607C)
    public static let gappsWatermelon = Color(hex: "#F0607C")
